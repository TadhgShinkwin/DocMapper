  ...
  <header class="masthead bg-primary text-white text-center nospace">
    <div class="row">
      <div class="toolbar col-md-3">
        <h3 class="text-uppercase toolhead mb-0"><?php echo $panelHeadLHS; ?></h3><!--Possibly edit the h1 to be a div-->

        <div class="font-weight-light mb-0 toolbar-inner"><?php echo $stringLHS; ?></div>
      </div>
      <div class="map col-md-9">
        <h3 class="text-uppercase mb-0"><?php echo $panelHeadRHS; ?></h3>
        <div class="map-inner"><?php echo $stringRHS; ?></div>
      </div>
    </div>
  </header>

  <footer class="footer-basic-centered mapfoot">
