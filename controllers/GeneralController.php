 ...
 * This is the controller for the Not Logged in  user type - Modified for my website
 * 
 *
 * 
 * 
        ...
        if (isset($this->getArray['pageID'])) { //check if a page id is contained in the URL
            switch ($this->getArray['pageID']) {
                case "home":
                    ...
                    $data['stringRHS'] = $home->getPanelContent_2();     // A string intended of the Left Hand Side of the page
